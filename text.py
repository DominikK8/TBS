...
ROOM1_1_LDESC = (
    ...
    "Du hast das Gefühl, dass aus Westen ein Hauch kam, vielleicht hast du ihn dir aber auch eingebildet."
)
...
ROOM1_3_LDESC = (
    ...
    "Du erahnst in der Dunkelheit Wege nach Süden und nach Westen."
)
...
ROOM1_4_LDESC = (
    ...
    "Im Halbschatten erkennst du Wege nach Norden, Westen und Süden."
)
...
ROOM1_5_LDESC = (
    ...
    "Im Osten scheint die Dunkelheit an Gewicht zu verlieren."
)
...
ROOM1_8_LDESC = (
    ...
    "Der Gang zieht sich nach Norden und nach Süden weiter."
)
...
ROOM2_1_LDESC = (
    ...
    "Doch nach Norden lüftet sich die Dunkelheit."
)
...
ROOM2_3_LDESC = (
    ...
    "Nach Norden fühlt sich die Luft weniger schwer an."
)
...
ROOM2_4_LDESC = (
    ...
    "Du spürst einen leichten Luftzug, der von Norden kommt."
)
...
ROOM2_12_LDESC = (
    ...
    "Im Süden fühlt sich die Luft weniger verbraucht an."
)
...
ROOM2_13_LDESC = (
    ...
    "Im Süden verliert der Ort an Schwere."
)
...
ROOM3_1_LDESC = (
    ...
    "Er zieht sich nach Osten und nach Westen weiter."
)
...
ROOM3_2_LDESC = (
    ...
    "Aus Norden spürst kalte Luft an dir vorbeiziehen."
)
...
ROOM3_4_LDESC = (
    ...
    "Der Weg führt nach Süden oder nach Westen."
)
...
ROOM3_6_LDESC = (
    ...
    "Dir fällt auf, dass du wesentlich mehr sehen kannst, wenn du nach Norden oder nach Osten schaust."
)

ROOM3_7_DESC = "Gang der Knospenruhe"
ROOM3_7_LDESC = (
    "Der Gang liegt ruhig da, als würde er warten. \n"
    "Er führt nach Westen und nach Osten. \n"
...
ROOM3_8_LDESC = (
    ...
    "Du kannst nach Westen zurück oder nach Süden weitergehen."
)
...
ROOM3_11_LDESC = (
    ...
    "Wege führen nach Süden, nach Osten und nach Westen. \n"
...
ROOM3_12_LDESC = (
    ...
    "Er führt nach Westen und nach Osten weiter."
)

ROOM3_13_DESC = "Gang der Wasseradern"
ROOM3_13_LDESC = (
    "Feine Linien ziehen sich wie Adern durch den Boden. \n"
    "Der Weg setzt sich nach Westen und nach Osten fort."
)
...
ROOM3_16_LDESC = (
    ...
    "Du kannst nach Norden gehen oder nach Osten weiterziehen."
)

ROOM3_17_DESC = "Kurve der Dämmerwedel"
ROOM3_17_LDESC = (
    "Die Kurve wirkt weich und nachgiebig. \n"
    "Wege öffnen sich nach Norden und nach Westen."
)
...
ROOM4_1_LDESC = (
    ...
    "Nach Süden führt der Weg zurück, nach Osten öffnet sich ein weiterer Gang."
)

ROOM4_2_DESC = "Hof der Pollenfahne"
ROOM4_2_LDESC = (
    "Feine Partikel scheinen in der Luft zu hängen, ohne sich zu setzen. \n"
    "Der Hof führt nach Westen und nach Osten weiter."
)
...
ROOM4_20_LDESC = (
    ...
    "Du kannst nach Norden gehen oder nach Süden zurückkehren."
)
